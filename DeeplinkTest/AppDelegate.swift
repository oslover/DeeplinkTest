...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let options = launchOptions, options[UIApplication.LaunchOptionsKey.userActivityDictionary] != nil {
            if let activityDictionary = options[UIApplication.LaunchOptionsKey.userActivityDictionary] as? [AnyHashable: Any],
                ...
                DeeplinkManager.shared.url = activity.webpageURL
            }
        }
    ...
    func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: @escaping ([UIUserActivityRestoring]?) -> Void) -> Bool {
        ...
        if userActivity.activityType == NSUserActivityTypeBrowsingWeb {
            DeeplinkManager.shared.url = userActivity.webpageURL
            return true
        }
        return false
    }
